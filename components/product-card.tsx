    ...
    <div className="group block">
      ...
      <div className="mt-3">
        ...
        {safeColors.length > 0 ? (
          <div className="mt-2 flex flex-wrap gap-1">
            {safeColors.slice(0, 4).map((color, index) => {
              ...
              const isValidCssColor =
                ...
                (typeof CSS !== "undefined" && CSS.supports && CSS.supports("color", color.toLowerCase()))
              ...
              const cssColor = isValidCssColor ? color.toLowerCase() : colorMap[color.toLowerCase()] || "#CCCCCC"
          ...
          <div className="mt-2">
            <div className="text-xs text-muted-foreground font-body">Single color variant</div>
          </div>
        )}
      </div>
    </div>
